...
class syntax_plugin_dirtylittlehelper_mermaid extends DokuWiki_Syntax_Plugin
{
        var $dlh_handle = '';
        ...
        */
        ...
        {
                $this->Lexer->addExitPattern('\<\/dlh\.mm\>','plugin_dirtylittlehelper_'.$this->getPluginComponent());
        ...
        public function handle($match, $state, $pos, Doku_Handler $handler)
        {
                ...
                switch ($state) {
                        ...
                        case DOKU_LEXER_ENTER:
                                if($match=='<dlh.mm>'){
                                        return array($state, 'MERMAID',$match);
                                }
