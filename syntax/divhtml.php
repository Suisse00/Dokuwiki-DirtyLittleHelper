...
class syntax_plugin_dirtylittlehelper_divhtml extends DokuWiki_Syntax_Plugin
{
        var $dlh_handle = '';
        ...
        */
        ...
        {
                $this->Lexer->addEntryPattern('\<dlh\.div\.html[^\>]*\>',$mode,'plugin_dirtylittlehelper_'.$this->getPluginComponent());
        }
        ...
        public function render($mode, Doku_Renderer $renderer, $data)
        {
                if ($mode == 'xhtml') {
                        ...
                        if($data[1]=='BEGIN'){
                                ...
                                $renderer->doc .= $renderer->doc .= str_replace('<dlh.div.html','<div',$data[2]);;
								return true;
